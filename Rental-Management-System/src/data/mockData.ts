import { 
  ...
  DashboardMetrics, ChartDataPoint, Notification
} from '@/types';
...
export const mockNotifications: Notification[] = [
  {
    ...
    message: 'Order #order-1 has been confirmed. Pickup scheduled for Jun 1, 2024.',
    link: '/orders',
    read: false,
    createdAt: new Date('2024-05-28T10:30:00'),
  },
  {
    id: 'notif-2',
    type: 'return',
    title: 'Return Reminder',
    message: 'Portable PA System rental is due for return on Jun 24, 2024.',
    link: '/orders',
    read: false,
  ...
  },
  {
    ...
    message: 'Invoice inv-1 has been fully paid. Amount: ₹5,220.',
    link: '/invoices',
    read: true,
    createdAt: new Date('2024-05-24T14:15:00'),
  },
  {
    id: 'notif-4',
    type: 'quotation',
    title: 'Quotation Accepted',
    message: 'John Customer has accepted quotation quote-1 for Professional Video Camera.',
    link: '/quotations',
    read: true,
    createdAt: new Date('2024-06-15T11:45:00'),
  },
  {
    id: 'notif-5',
    type: 'system',
    title: 'System Update',
    message: 'RentFlow has been updated with new features. Check the dashboard for details.',
    read: false,
